...
export async function POST() {
  try {
    const pritiDataSheetId = resolveSpreadsheetId(
      process.env.PRITI_DATA_SHEET_ID,
      process.env.COLLECTION_SHEET_URL
    );
    const reportPRQSheetId = resolveSpreadsheetId(
      process.env.REPORT_PRQ_SHEET_ID,
      process.env.REPORT_PRQ_SHEET_URL
    );
