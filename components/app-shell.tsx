      ...
      <main className="relative flex h-full flex-1 flex-col overflow-hidden">
        <header className="z-10 flex h-16 items-center justify-between border-b border-slate-200 bg-white px-8">
          ...
          <div className="flex items-center space-x-3">
            <div className="flex h-10 w-10 select-none items-center justify-center rounded-full border-2 border-brand-500 bg-brand-500 text-sm font-semibold tracking-wider text-white shadow-sm">
              <span>{avatarName.slice(0, 2).toUpperCase()}</span>
            </div>
